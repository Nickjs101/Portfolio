    ...
    <div>
      <div className='hidden lg:col-span-1 gap-4 lg:flex flex-wrap p-4'>
          {projects.map((project, index) => (
              <div key={index} className= {`p-4 h-[250px] md:min-w-fit lg:w-full ${project.component === currentProject? 'bg-secondary-color' : 'bg-fourth-color'}  secondary-color mb-2 rounded-xl`} onClick={(e) => setCurrentProject(e,'Content',project.component)}>
